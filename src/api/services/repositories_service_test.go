...
func TestCreateRepoNoError(t *testing.T) {
	...
	restclient.AddMockup(restclient.Mock{
		...
		Response: &http.Response{
			...
			Body:       ioutil.NopCloser(strings.NewReader(`{"id": 123, "name": "testing", "owner": {"login": "rjunior"}}`)),
		},
	})
	...
	assert.EqualValues(t, "rjunior", result.Owner)
}
...
func TestCreateRepoConcurrentNoError(t *testing.T) {
	...
	assert.EqualValues(t, "rjunior", result.Response.Owner)
}
...
func TestCreateReposAllSuccess(t *testing.T) {
	...
	assert.EqualValues(t, "rjunior", result.Results[0].Response.Owner)
	...
	assert.EqualValues(t, "rjunior", result.Results[1].Response.Owner)
}
